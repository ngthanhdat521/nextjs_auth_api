...
import { create } from './TextEditorConfig';
...
export default function Editor() {
  ...
  return (
    <div className='w-full border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600 overflow-hidden'>
      <div className='flex px-6 py-3 items-center gap-3'>
        <Avatar
          src='https://s.gravatar.com/avatar/8e1da5b7dc8bc3c4f69c2a9a4ff31406?s=480&r=pg&d=https%3A%2F%2Fcdn.auth0.com%2Favatars%2Fus.png'
          className='w-10 h-10'
        />
        <div>
          <p className='text-base text-gray-900'>David John</p>
          <p className='text-xs text-gray-500'>Blogs</p>
        </div>
      </div>
      <div className='flex px-6 py-3 items-center gap-3 bg-white'>
        <input
          type='text'
          placeholder='Title for Blog'
          className='block w-full p-2 text-gray-900 rounded-lg border-none bg-gray-100 text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500'
        />
        <select
          className='bg-gray-100 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-[0.38rem] dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 w-1/4 border-none'
        >
          <option >Choose a category</option>
          <option value='US'>Marketing</option>
          <option value='CA'>Food</option>
          <option value='FR'>Study</option>
          <option value='DE'>Work</option>
        </select>
      </div>
      <div className='p-6 bg-white rounded-b-lg dark:bg-gray-800'>
        <div
          id='wysiwyg-example'
          className='w-full text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400 focus:max-h-[60vh] max-h-[60vh] overflow-y-scroll'
        />
      </div>
      <div className='px-6 py-3 border-b dark:border-gray-600 flex justify-between items-end'>
        <div>
          <div className='flex flex-wrap items-center'>
            <div className='flex items-center space-x-1 rtl:space-x-reverse flex-wrap'>
              ...
              <div className='px-1'>
                <span className='block w-px h-4 bg-gray-300 dark:bg-gray-600' />
              </div>
              <button
